#!/usr/bin/env bash
# After the stage 1 apply, writes envs/phase2.auto.tfvars with the account IDs
...
cat > envs/phase2.auto.tfvars <<EOF
log_archive_account_id = "${log_archive_id}"
baseline_account_ids = ${vended_json}
EOF

echo "wrote envs/phase2.auto.tfvars; now set phase2_enabled = true and apply"
